...
public class EditHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((EditText) findViewById(R.id.zip)).setText(zip);
        ((EditText) findViewById(R.id.roofsize)).setText(roofsize);
        ((EditText) findViewById(R.id.roofpitch)).setText(roofpitch);
        ((EditText) findViewById(R.id.costestimate)).setText(costest);
    ...
    public void Save(View v){
            ...
            {
                Toast.makeText(EditHome.this, "All Fields Are Required!",Toast.LENGTH_LONG).show();
                }*/
            if(etname.length() == 0){
                etname.requestFocus();
            ...
            else if(!etname.getText().toString().matches("[a-zA-Z ]+"))
            {
                ...
                db.update(Integer.parseInt(id), name, number, email, address, city, state, zip, roofsize, roofpitch, costest, comments);
    ...
    public void calcHome(View v){
        ...
        if(txtFirstNumEdit.length() == 0){
            ...
            Toast.makeText(EditHome.this, "Home Calculated Results Below!",Toast.LENGTH_LONG).show();
